...
public class BungalowDTO 
{
	...
	public BungalowDTO(Long bungalowId, String bungalowName, String bungalowType) {
		super();
		this.bungalowId = bungalowId;
		this.bungalowName = bungalowName;
		this.bungalowType = bungalowType;
	...
	public String toString() {
		return "BungalowDTO [bungalowId=" + bungalowId + ", bungalowName=" + bungalowName + ", bungalowType=" + bungalowType + "]";
	}
